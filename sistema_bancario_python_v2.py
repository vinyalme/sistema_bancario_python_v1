...
def depositar(saldo, valor, extrato, /):  #operação de Deposito
...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):  #operação de Saque
...
def exibir_extrato(saldo, /, *, extrato):  #operação de Extrato
    print("\n================ EXTRATO ================")
    print("Não foram realizadas movimentações." if not extrato else extrato)
    print(f"\nSaldo:\t\tR$ {saldo:.2f}")
    print("==========================================")

def criar_usuario(usuarios):  #operação de Criar Usuario
...
def filtrar_usuario(cpf, usuarios):  #operação de Filtrar Usuario
    usuarios_filtrados = [usuario for usuario in usuarios if usuario["cpf"] == cpf]
    return usuarios_filtrados[0] if usuarios_filtrados else None

def criar_conta(agencia, numero_conta, usuarios):  #operação de Nova de Conta ou Criar Conta
...
def listar_contas(contas):  #operação de Listar Contas
    for conta in contas:
        linha = f"""\
...
def main():
    ...
    while True:
        ...
        elif opcao == "nu":  #operação de Criar Usuario
            criar_usuario(usuarios)

        elif opcao == "nc":  #operação de Nova de Conta ou Criar Conta
        ...
        elif opcao == "lc":  #operação de Listar Contas
